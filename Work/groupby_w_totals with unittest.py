...
class ttest_check_vars_string_elements_for_errors(unittest.TestCase):

    # unittest for exceptions https://stackoverflow.com/questions/129507/how-do-you-test-that-a-python-function-throws-an-exception
    def ttest_invalid_field_name(self):
        """ Test for invalid fieldname"""
        self.assertRaises(BaseException, check_vars_string_elements_for_errors, "999",)

    def ttest_invalid_field_name2(self):
        """ Test for invalid fieldname"""
        self.assertRaises(ValueError, check_vars_string_elements_for_errors, "999",)
